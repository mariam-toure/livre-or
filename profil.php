...
if(isset($_POST["submit"])) {
    if (isset($_POST['login']) && isset($_POST['password1']) && isset($_POST['password2'])) {
        ...
        if($password1 === $password2){
            $update_sql = "UPDATE `utilisateurs` SET login = '$login', password = '$password1' WHERE id = '$id'";
         ...
         <div class="container">
               <form method="post" class="myform" style="text-align: center";>
                  ...
                  <label for="password1">Password</label><br>
                     <input type="password" id="password1" name="" placeholder="Nouveau votre mot de passe"><br>
